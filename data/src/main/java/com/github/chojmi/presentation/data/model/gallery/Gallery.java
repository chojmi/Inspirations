package com.github.chojmi.presentation.data.model.gallery;

import android.os.Parcelable;

import com.github.chojmi.presentation.data.model.Photo;
...
public abstract class Gallery implements Parcelable {
    ...
    public static Gallery createEmpty() {
        return new AutoValue_Gallery(0, 0, 0, 0, Collections.EMPTY_LIST);
    }
